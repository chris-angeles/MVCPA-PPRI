...
If Button = "save" Then
		...
		Else
			Response.Redirect(ApplicationSchema & ".asp?GranteeID=" & GranteeID & "&AppID=" & AppID & _
				"&FiscalYear=" & FiscalYear & "&GrantClassID=4")
		End If
...
ElseIf Button = "GSA" Then
	...
	Else
		Response.Redirect("/" & ApplicationSchema & "/gsa.asp?AppID=" & AppID)
	End If
...
ElseIf Button="Statistics" Then
	If Debug = True Then
		Response.Write("<a href=""Statistics.asp?AppID=" & AppID & "&ApplicationSchema=Application"">Cash Match</a>")
	Else
		Response.Redirect("Statistics.asp?AppID=" & AppID & "&ApplicationSchema=Application")
	End If
ElseIf IsNumeric(Button) Then
	...
	Else
		...
		End If
	End If
End If%><!--#include file="../includes/prepDB.asp"-->