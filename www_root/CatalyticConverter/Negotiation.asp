...
If AppID>0 Then 
	sql = "SELECT G.GranteeID, G.GranteeName, G.ORI, ORI.Agency AS ORIAgency, G.OrganizationTypeID, OT.OrganizationType, G.StatePayeeIDNo, " & vbCrLf & _
		...
		"	AuthorizedOfficialID, AO.Name AS AuthorizedOfficial, AO.Title AS AuthorizedOfficialTitle, ISNULL(I.AppID,0) AS AppID, ProgramName, " & vbCrLf & _
...
<%
	...
	Else
		Response.Write("<div style=""text-align: center""><a href=""/Negotiation/Matches.asp?AppID=" & AppID & "&MatchTypeID=1"" class=""plainlink"">Cash Match</a></div>" & vbCrLf)
	End If
