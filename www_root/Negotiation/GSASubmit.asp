...
If Debug = True Then
	If GrantClassID = 4 Then
		Response.Write("<a href=""/CatalyticConverter/Negotiation.asp?AppID=" & AppID & """>return to App</a><br />" & vbCrLf)
...
Else
	If GrantClassID = 4 Then
		Response.Redirect("/CatalyticConverter/Negotiation.asp?AppID=" & AppID)
	ElseIf FiscalYear >= 2022 Then
