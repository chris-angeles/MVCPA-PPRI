...
sql = "SELECT A.AppID, A.FiscalYear, G.GranteeID, G.GranteeName, A.HistoricalDataYear, " & vbCrLf & _
	"	A.SubmitID, A.SubmitTimestamp, U.Name AS SubmitName " & vbCrLf & _
	"FROM Grantees AS G " & vbCrLF & _
	"LEFT JOIN " & ApplicationSchema & ".Main AS A ON A.GranteeID=G.GranteeID " & vbCrLF & _
...
Sub WriteBudgetRow(vStatisticsID, i, vJurisdiction, vMVT1, vBMV1, vFRMVC1, vMVT2, vBMV2, vFRMVC2, vPermitEdit)
	...
	Response.Write(WriteInCell(IntegerField("BMV1_" & i, vBMV1, 8, 11, vPermitEdit, "changedIntegerField(this);")))
	Response.Write(WriteInCell(IntegerField("FRMVC1_" & i, vFRMVC1, 8, 11, vPermitEdit, "changedIntegerField(this);")))
	Response.Write(WriteInCell(IntegerField("MVT2_" & i, vMVT2, 8, 11, vPermitEdit, "changedIntegerField(this);")))
	Response.Write(WriteInCell(IntegerField("BMV2_" & i, vBMV2, 8, 11, vPermitEdit, "changedIntegerField(this);")))
	Response.Write(WriteInCell(IntegerField("FRMVC2_" & i, vFRMVC2, 8, 11, vPermitEdit, "changedIntegerField(this);")))
	If PermitEdit = True Then
