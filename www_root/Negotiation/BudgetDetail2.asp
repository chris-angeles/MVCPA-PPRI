...
Dim debug, i, j, k, PermitEdit, AppID, GrantClassID, GranteeID, GranteeName, FiscalYear, _
	...
	BudgetCashMatch, RoundCurrency, SubmitID, SubmitByName, SubmitTimestamp, AppURL, NegotiationLocked
...
sql = "SELECT A.BudgetItemID, A.AppID, A.BudgetCategoryID, A.Description, A.NoOfItems, A.SubCategoryID, B.SubCategory, " & vbCrLf & _
	"	A.PctTime, A.PctSalary, A.MVCPAFunds, A.CashMatch, A.InKindMatch, A.LineTotal, " & vbCrLF & _
...
Sub WriteBudgetRow(vBudgetItemID, vBudgetCategoryID, i, vTitle, vNoOfItems, vSubCategoryID, vPctTime, vPctSalary, vMVCPAFunds, vCashMatch, vInKindMatch, vLineTotal, vAddColor, vPermitEdit)
	...
	End If
	Response.Write(WriteInCell(CurrencyFieldRoundColor("MVCPAFunds_" & i, vMVCPAFunds, 10, 11, RoundCurrency, False, vColor, "")))
	Response.Write(WriteInCell(CurrencyFieldRoundColor("CashMatch_" & i, vCashMatch, 10, 11, RoundCurrency, False, vColor, "")))
	Response.Write(WriteInCell(CurrencyFieldRoundColor("LineTotal_" & i, vLineTotal, 10, 11, RoundCurrency, vPermitEdit, vColor, "changedCurrencyField(this);") & vbCrLf _
