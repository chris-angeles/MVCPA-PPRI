...
If Quarter < 5 Then
	sql = "SELECT H.FiscalYear AS Fiscal_Year, ISNULL(I.Quarter," & prepIntegerSQL(Quarter) & ") AS Quarter, H.GrantID, " & vbCrLf & _
		...
		"	J.Questions, J.Answered AS Responses, " & vbCrLf & _
	...
	sql = sql &	") AS J ON J.GrantID=H.GrantID " & vbCrLf & _
		"WHERE FiscalYear=" & FiscalYear & " AND H.GrantClassID=1 " & vbCrLf
...
<html lang="en-us">
<head>
<title><%=FiscalYear%> Taskforce Grant Progress Report Status Report</title>
<link rel="shortcut icon" href="/favicon.ico" type="image/x-icon" /> 
<link rel="stylesheet" href="/styles/main.css" type="text/css" /> 
</head>
<body style="width: 100%">
<div class="sectiontitle" style="white-space: nowrap;"><%=FiscalYear%> Taskforce Grant Progress Report Status Report</div>
<div>
...
If rs.EOF = False Then
	...
	While rs.EOF = False
		...
		ElseIf Quarter=5 Then
			Response.Write("<td style=""text-align: center; ""><a href=""YearEnd.asp?GrantID=" & rs.Fields("GrantID") & """ target=""_blank"">" & rs.Fields("Fiscal_Year") & "/YE</a></td>" & vbCrLf)
		End If
		For i = 2 To (rs.Fields.Count-1)
