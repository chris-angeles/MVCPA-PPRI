...
If ShowExcel = True Then
	...
	Response.AddHeader "content-disposition", "filename=BudgetDump" & FiscalYear & ".xls"
...
sql = "SELECT * FROM [Grants].vwGrantBudget WHERE [Fiscal Year]=" & prepIntegerSQL(FiscalYear) & " ORDER BY Grantee, [Budget Category ID] "
If Debug = True Then
