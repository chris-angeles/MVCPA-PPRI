...
If ShowExcel = True Then
	...
	Response.AddHeader "content-disposition", "filename=CostBasis" & FiscalYear & ".xls"
Else ' Start of Web only code
	Response.ContentType = "text/html"
%><!DOCTYPE html>
<html lang="en-us">
<head>
<title>MVCPA Cost Basis</title>
...
sql = "SELECT * FROM Application.vwCostBasis WHERE FiscalYear=" & prepIntegerSQL(FiscalYear) & " ORDER BY 3,1 "
If Debug = True Then
