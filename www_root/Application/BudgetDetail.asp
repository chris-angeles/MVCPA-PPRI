...
Dim debug, i, j, k, PermitEdit, AppID, GrantClassID, GrantClass, GranteeID, GranteeName, FiscalYear, _
	...
	SubmitID, SubmitByName, SubmitTimestamp, RoundCurrency, AppURL
...
<html lang="en-us">
<head>
<title>MVCPA <%=GrantClass %> Application for <%=GranteeName %></title>
...
Sub WriteBudgetRow(vBudgetItemID, vBudgetCategoryID, i, vTitle, vNoOfItems, vSubCategoryID, vPctTime, vPctSalary, vMVCPAFunds, vCashMatch, vInKindMatch, vLineTotal, vPermitEdit)
	...
	End If
	Response.Write(WriteInCell(CurrencyFieldRound("MVCPAFunds_" & i, vMVCPAFunds, 10, 11, RoundCurrency, vPermitEdit, "changedCurrencyField(this);")))
	Response.Write(WriteInCell(CurrencyFieldRound("CashMatch_" & i, vCashMatch, 10, 11, RoundCurrency, vPermitEdit, "changedCurrencyField(this);")))
	Response.Write(WriteInCell(CurrencyFieldRound("LineTotal_" & i, vLineTotal, 10, 11, RoundCurrency, False, "") & vbCrLf _
