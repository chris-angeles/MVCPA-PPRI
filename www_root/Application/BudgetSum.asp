...
If ShowExcel = True Then
	...
	Response.AddHeader "content-disposition", "filename=BudgetSum" & FiscalYear & ".xls"
Else ' Start of Web only code
	Response.ContentType = "text/html"
%><!DOCTYPE html>
<html lang="en-us">
<head>
<title>MVCPA Budget Sum</title>
...
sql = "SELECT * FROM Application.vwBudgetSum WHERE FiscalYear=" & prepIntegerSQL(FiscalYear)
If Debug = True Then
